...
local theme = lush(function()
  return {
    ...
    DiagnosticUnderlineError { bg = palette.background, gui = "underline", sp = palette.red },
    DiagnosticUnderlineWarn { bg = palette.background, gui = "underline", sp = palette.orange },
    DiagnosticUnderlineHint { bg = palette.background, gui = "underline", sp = palette.blue },
    DiagnosticUnderlineInfo { bg = palette.background, gui = "underline", sp = palette.purple },
