...
local theme = lush(function()
  return {
    ...
    DiagnosticUnderlineError { bg = palette.background, gui = "underline", sp = palette.red.lighten(10) },
    DiagnosticUnderlineWarn { bg = palette.background, gui = "underline", sp = palette.orange.lighten(10) },
    DiagnosticUnderlineHint { bg = palette.background, gui = "underline", sp = palette.blue.lighten(10) },
    DiagnosticUnderlineInfo { bg = palette.background, gui = "underline", sp = palette.purple.lighten(10) },
